...
/// [JTExpansionTile] to save and restore its expanded state when it is scrolled
/// in and out of view.
///
/// See also:
///
...
class JTExpansionTile extends StatefulWidget {
  /// Creates a single-line [ListTile] with a trailing button that expands or collapses
  /// the tile to reveal or hide the [children]. The [initiallyExpanded] property must
  /// be non-null.
  const JTExpansionTile({
    Key? key,
    this.leading,
    required this.title,
    this.subtitle,
  ...
  @override
  _JTExpansionTileState createState() => _JTExpansionTileState();
}

class _JTExpansionTileState extends State<JTExpansionTile>
        ...
        children: <Widget>[
          ListTileTheme.merge(
            ...
            child: ListTile(
              ...
              hoverColor: _backgroundColor!.value,
              tileColor: _backgroundColor!.value,
              selectedTileColor: _backgroundColor!.value,
