...
class PopoverPath {
  ...
  Path draw(
    ...
    } else if (direction == PopoverDirection.bottomRight) {
      _drawBottomRightElemet(path, arrowRect, bodyRect);
    } else if (direction == PopoverDirection.bottomLeft) {
      _drawBottomLeftElement(path, arrowRect, bodyRect);
    } else {
  ...
  void _drawBottomRightElemet(Path path, Rect arrowRect, Rect bodyRect) {
    path.moveTo(arrowRect.right, arrowRect.top);
    path.lineTo(arrowRect.left, arrowRect.top + arrowRect.height / 2);
    path.lineTo(arrowRect.right, arrowRect.bottom);
  ...
  void _drawBottomLeftElement(Path path, Rect arrowRect, Rect bodyRect) {
    path.moveTo(arrowRect.left, arrowRect.top);
    path.lineTo(arrowRect.right, arrowRect.top + arrowRect.height / 2);
    path.lineTo(arrowRect.left, arrowRect.bottom);
